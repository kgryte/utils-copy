...
* @returns {Boolean} boolean indicating if an input value is a Buffer object
*/
function isBuffer( val ) {
	return val !== null && val.constructor && typeof val.constructor.isBuffer === 'function' && val.constructor.isBuffer( val );
...
*	Copies and deep clones a value with the ability to specify copy depth.
*
